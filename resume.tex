...
\vspace{-10pt}
Distinction average mark. Currently persuing Honours, First Class. Expected graduation in November 2016.
...
\item[\textbf{Advanced Operating Systems:}] Wrote a small OS on top of the SeL4 microkernel as part of a pair project. Major contributions included asynchronous file I/O and advanced memory management. Programmed using Rust, a sophisticated systems language developed by Mozilla. Developed skills in low-level design and programming in a concurrent context. Achieved Distinction mark.
